...
ImageProcessor::image_st ImageProcessor::readImageFile(std::string image_filename, int target_width, int target_height, int target_channels)
{
...
void ImageProcessor::writeImageFilePNG(std::string image_filename, ImageProcessor::image_st image)
{
