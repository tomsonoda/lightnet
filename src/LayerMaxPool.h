...
struct LayerMaxPool
{
	...
	void backwardGPU( float *dz_next_layer )
	{
		...
		gpu_cuda::maxPoolBackwardGPU( gpu_dz_in, gpu_dz, gpu_in, gpu_out, dz.size.b, dz.size.x, dz.size.y, dz.size.z, dz_in.size.x, dz_in.size.y, dz_in.size.z, stride, kernel_size );
	}
